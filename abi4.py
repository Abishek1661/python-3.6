...
gye = LINE("EvBEwSSREtzmyqTwF851.yNV86jU61+7UM7p2T7Queq.x51qPSTJthz4OP7STrCQhnkH5RoqmzNIFfasAX2i4fU=")
ais = LINE("EuYzSsLDjmyjbZNZSMg4.FZBJKCdPaMkGlO+SbNUM5a.Rep2n2H/8Yva4QFGVtZLiTrkyrnbbLWuB/4bBQkE7K0=")
ki2 = LINE("EuJdKMRdetRdesZhQ2qe.DPn2kpMKmgdY+xdn+IvtZG.fxycM6A9XZExh87oMT/nrNn0Vjfduj+sFGlxwsctDXo=")
ki3 = LINE("EuMzt80joLDICawMLMK5.rgGsX0qFn261Cbmvazkibq.5ILOpV+TEPzRh95Ks+T3ugQwrCjUD89sH8ccnx9Ohx4=")
ki4 = LINE("EumNlo7o1efWHaHQnwN1.Qrgq15tadMC1mKyPmhwJOq.Q/m89ms2ixLRoDtvaMCcKKUJrRgzdzgZH9cwJu1DOM4=")
botStart = time.time()
...
creator = ["u627bfce89bbad7feee9bb3f6b7ba9411"]
Owner = ["u627bfce89bbad7feee9bb3f6b7ba9411"]
admin = ["u627bfce89bbad7feee9bb3f6b7ba9411"]
...
#==============================================================================#
                if text.lower() == 'help':
                    ...
                    gye.sendContact(to, "u86cb9fd5c1a0d078526a70aa0a1a024d")
                    gye.sendMessage(to,"█░░╦─╦╔╗╦─╔╗╔╗╔╦╗╔╗░░█\n█░░║║║╠─║─║─║║║║║╠─░░█\n█░░╚╩╝╚╝╚╝╚╝╚╝╩─╩╚╝░░█")
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "u86cb9fd5c1a0d078526a70aa0a1a024d"
